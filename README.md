...
1. Start local Supabase:
  - `npx supabase start`
2. Seed test data:
  - Run the content of `supabase\snippets\seeder_for_danlosadriandev@gmail.com.sql` in `http://localhost:55423/project/default/sql`, which is an in-browser SQL editor in Supabase Studio.
