    ...
    <div className="app privacy-page">
      ...
      <div className="privacy-landing">
        <main className="privacy-landing__content">
          <div className="privacy-landing__hero">
          ...
          <section className="privacy-landing__section">
            <h3>Key features</h3>
            <ul>
          ...
          <section className="privacy-landing__section" id="terms">
            <h3>Terms</h3>
            <p>
          ...
          <div className="privacy-landing__actions">
            <a className="privacy-landing__primary" href="/">
              Sign in to the app
            </a>
          </div>
        </main>
