const en = {
  ...
  auth: {
    ...
    resetPasswordEmailSent: 'If an account exists for this email, you will receive a reset link shortly.',
    resetPasswordEmailError: 'Unable to send reset email.',
    setNewPassword: 'Set a new password',
    setNewPasswordHint: 'Choose a password for your account.',
  ...
  intro: {
    ...
    subtitle: 'We believe that understanding how you feel should be simple.',
  ...
  settings: {
    ...
    personalSleepTargetHours: 'Ideal sleep hours',
    sleepTargetHelper: 'Used to show you personalized insights and stats.',
    eventInsightsMinCount: 'Minimum entries per event needed',
    eventInsightsMinCountHelper: 'Only events with at least this many entries will appear in your insights.',
  ...
  paywall: {
    premium: 'Premium',
    unlockPro: 'Rythm Pro',
    upgradeToAccess: 'Go Pro: personalized insights and stats that will amaze you.',
    ...
    features: {
      ...
      sleepMoodChart: 'See how sleep and mood connect in one simple chart',
      weeklyMonthlyTrends: 'Weekly and monthly trends',
      historyRanges: '7/30/90 day history',
      exportReports: 'Export Rythm\'s custom PDF reports',
    },
  },
  feedback: {
  ...
  log: {
    ...
    loading: 'Loading...',
    openDatePicker: 'Open calendar to change date',
    closeDatePicker: 'Close calendar',
    tip: 'Log your mood at the end of the day',
    ...
    sleepTimePickerSelectTime: 'Select time',
    sleepTimePickerEnterTime: 'Enter time',
    sleepTimePickerHour: 'Hour',
    sleepTimePickerMinute: 'Minute',
    sleepTimePickerClear: 'Clear',
    ...
    defaultTags: {
      ...
      eveningScreens: 'evening screens',
      lateBedtime: 'late bedtime',
      exercise: 'exercise',
      fragmentedSleep: 'fragmented sleep',
      alcoholConsumption: 'alcohol consumption',
      progressFeeling: 'progress feeling',
      social: 'social',
      sunlight: 'sunlight',
    },
  ...
  insights: {
    ...
    pro: 'Pro',
    heatmap: 'Heatmap',
    timelineComingSoon: 'Timeline will be available soon.',
    ...
    timelineFilters: {
      ...
      atLeast: '≥',
      atMost: '≤',
      searchEvents: 'Find or create an event',
      findEvent: 'Find an event',
      clearAll: 'Remove filters',
    ...
    noEntryForDay: 'No data for your current filters.',
    ...
    weekdayPreviewBannerIntro: 'This is an example weekly pattern.',
    weekdayPreviewBannerOutro: 'to see your own.',
    eventsPreviewBannerIntro: 'These are example insights.',
    eventsPreviewBannerOutro: 'to see your own.',
    logOneMoreDayWithEvents: 'Log 1 more day with daily events',
    logMoreDaysWithEvents: 'Log {{count}} more days with daily events',
    tagPreview: {
      morningWalk: 'Morning walk',
      socialPlans: 'Plans with friends',
      lateNightScreen: 'Late-night screen time',
      stressDeadline: 'Work deadline stress',
    },
    avgSleep: 'Avg sleep',
    avgMood: 'Avg mood',
    bestMoodDay: 'Best mood',
    worstMoodDay: 'Worst mood',
    mostSleepDay: 'Most sleep',
    leastSleepDay: 'Least sleep',
    logsCount: '{{count}} logs',
    dailyHistory: 'Daily history',
    dailyHistoryTooltip: 'The 90-day view groups points in 3-day buckets for readability.',
    dailyHistorySubtitle: 'Day-by-day sleep and mood for the last 7, 30, and 90 days',
    ...
    scatterSubtitle: 'Sleep and mood visualized to reveal hidden patterns.',
    bestSleepRange: 'Optimal range: {{from}}–{{to}}.',
    ...
    timelineAvgMoodLine: 'Avg. mood: {{value}}',
    timelineAvgSleepLine: 'Avg. sleep: {{value}}',
    ...
    eventsPredictMood: 'What predicts your mood',
    eventsPredictSleep: 'What predicts your sleep',
    ...
    showAllTags: 'Show all events',
    showTopTags: 'Show top events',
    daysSuffix: '{{count}} days',
    addEventsToSeeMoodImpact: 'Add daily events to see mood impact (min {{count}} entries per event).',
    addEventsToSeeSleepImpact: 'Add daily events to see sleep impact (min {{count}} entries per event).',
    ...
    overAverage: 'over avg',
    underAverage: 'under avg',
    last7Days: 'Last 7 days',
    last30Days: 'Last 30 days',
    last90Days: 'Last 90 days',
    sleepDeltaMinutes: '{{count}}m',
    sameAsOverallAverage: 'Same as overall average',
    scatterRange7Days: '7 days',
    ...
    moodBySleepSubtitleUp: 'Higher',
    moodBySleepSubtitleDown: 'Lower',
    moodBetter: 'better',
    moodLower: 'lower',
    ...
    progressToTargetLabel: 'Progress',
    progressToTargetHoursSummary:
      'Recent sleep <avg>{{avg}}</avg> · <goal>{{target}}</goal> target',
    progressToTargetTargetOnly: 'Aim for about <goal>{{target}}</goal> of sleep per night',
    ...
    notOptimalRangeTitle: 'Your average sleep is below your target.',
    notOptimalRangeBody: 'Try to get closer to your sleep target over the next few days to improve your well-being.',
  },
  reports: {
  ...
  notifications: {
    ...
    title: 'Log your day',
    body: 'Tap to add sleep and mood.',
    nudgeTitle: 'Want a daily reminder?',
    nudgeBody: 'We\'ll send a quick reminder once a day to add your sleep and mood. You can change the time anytime in Settings.',
    nudgeEnableAction: 'Allow',
  ...
  support: {
    sleepSavedOneMoreTap: 'Sleep saved. One more tap to add your mood and you are done. You got this!',
    moodSavedAddSleep: 'Mood saved. Add your sleep too and you will have a complete picture.',
  ...
  badges: {
    ...
    eventsExplorer: {
      ...
      tier5: '30 different daily events',
    },
    eventsMaster: {
      title: 'Events Master',
    ...
    bounceBack: {
      title: 'Bounce Back',
      description: 'A mood recovery after several low days.',
    },
  },
  errors: {
