const en = {
  ...
  insights: {
    ...
    weekdayPreviewBanner: 'This is an example weekly pattern. <logLink>Log {{count}}+ days</logLink> to see your own.',
    eventsPreviewBanner: 'These are example insights. <logLink>Log {{count}}+ days with daily events</logLink> to see your own.',
    tagPreview: {
