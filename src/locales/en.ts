const en = {
  ...
  log: {
    ...
    tip: 'Tip: log your data every night before bed. The more you add, the clearer you\'ll see what helps you feel better.',
  ...
  insights: {
    ...
    notOptimalRangeBody: 'Try getting a little closer to your recommended sleep target over the next few days for better well-being.',
  },
  reports: {
